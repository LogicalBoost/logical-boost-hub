...
// Ad Builder
// ============================================================================
export type AdComponentType = 'BH' | 'SH' | 'T' | 'PC' | 'CTA'

export const AD_COMPONENT_TYPES: { value: AdComponentType; label: string; help: string }[] = [
  { value: 'BH',  label: 'Banner Headline',     help: 'Top-slot hook. Calls out the audience by name or trait. ≤60 chars.' },
  { value: 'SH',  label: 'Subheadline',         help: 'Body slot option. Supports the headline.' },
  { value: 'T',   label: 'Trust Signal',        help: 'Body slot option. Credibility line (years in business, license, etc.).' },
  { value: 'PC',  label: 'Proof Copy',          help: 'Body slot option. Specific results, numbers, testimonials.' },
  { value: 'CTA', label: 'Call to Action',      help: 'CTA slot. Action verb the user should take.' },
]

export const AD_BODY_TYPES: AdComponentType[] = ['SH', 'T', 'PC']
...
export interface AdComponent {
  ...
  content: string
  audience_ids: string[]      // populated for BH; empty for others
  per_client_seq: number      // the integer used in the ad name (BH4, T2, CTA7…)
  version: number
  status: 'approved' | 'denied'
  created_by: string | null
  created_at: string
...
export interface Ad {
  ...
  offer_id: string
  audience_id: string
  bh_component_id: string
  body_component_id: string
  cta_component_id: string
  bh_component_version: number
  body_component_version: number
  cta_component_version: number
  name: string                // generated by trigger; e.g. IMMI_UNDOC_BH4-T2-CTA7
  status: 'approved' | 'denied'
  created_by: string | null
  created_at: string
  updated_at: string
